...
- Neural discrete representation learning. *[NeurIPS'17]* [[Paper]](https://arxiv.org/abs/1711.00937) [[Code]](https://github.com/google-deepmind/sonnet/blob/v1/sonnet/python/modules/nets/vqvae.py; https://huggingface.co/docs/diffusers/v0.23.1/en/api/models/vq#diffusers.VQModel)
